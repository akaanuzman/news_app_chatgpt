...
final class StringConstants {
  ...
  static const String onboardTitle  = "Get the latest and updates news easily with News App";
  static const String onboardSubtitle = "Get the latest updates on the most popular and hot news with News App";
